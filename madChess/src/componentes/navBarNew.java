...
public class navBarNew extends JPanel{
	...
	public navBarNew(RButton btn) {
         ...
         panelLogo.setBorder(BorderFactory.createEmptyBorder(0, Escalador.escalar(20), 0, 0));
   		...
   		panelBtn.setBorder(BorderFactory.createEmptyBorder(0, 0, 0, Escalador.escalar(20)));
   		panelBtn.add(Box.createRigidArea(Escalador.newDimension(0, Escalador.escalar(80))));
   		...
   		linea.setBounds(0, Escalador.escalar(-65), Escalador.escalar(1000), Escalador.escalar(225));
   		...
   		userIcon.setBounds(Escalador.escalar(825), Escalador.escalar(30), Escalador.escalar(100), Escalador.escalar(100));
